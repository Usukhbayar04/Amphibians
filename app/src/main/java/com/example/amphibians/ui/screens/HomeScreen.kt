...
fun HomeScreen(
    ...
    retryAction: () -> Unit, // Параметр нь аргумент авдаггүй бөгөөд утга буцаахгүй
    modifier: Modifier = Modifier,
    contentPadding: PaddingValues = PaddingValues(0.dp)
) {
    // amphibiansUiState нөхцөл шалган таарсан дэлгэцийг буцаана.
    when (amphibiansUiState) {
        ...
        // Хэрвээ дээрх төлөв байхгүй байвал алдааны мэдээллийг харуулна.
        else -> ErrorScreen(retryAction, modifier)
    }
}

// Ачаалалж байгааг харуулах дэлгэц
@Composable
...
// Алдаа заавал дахин ачааллах мессэжийг харуулна.
@Composable
